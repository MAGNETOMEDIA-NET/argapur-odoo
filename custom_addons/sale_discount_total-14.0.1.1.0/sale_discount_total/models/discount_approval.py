...
class Company(models.Model):
    ...
    ], string="Approvals levels", default='one_step',
...
class ResDiscountSettings(models.TransientModel):
    ...
    so_double_validation = fields.Selection(related='company_id.so_double_validation',string="Approvals levels *", readonly=False)
